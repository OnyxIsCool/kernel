...
if getgenv().DexScannerLoaded then return end
getgenv().DexScannerLoaded = true
...
task.defer(function()
    ...
    local function ScanObj(obj)
        pcall(function()
            if obj:IsA("RemoteEvent") or obj:IsA("RemoteFunction") then
                warn("[Dex Scanner] Remote:", obj:GetFullName())
            end
        end)
    end
    ...
    LogService.MessageOut:Connect(function(message)
        pcall(function()
            ...
            if lower:find("kick") or lower:find("ban") or lower:find("mimic") or lower:find("crash") then
                notify("LogService detected: "..message)
            end
        end)
    end)
    ...
    if mt and not getgenv().DexNamecallHooked then
        getgenv().DexNamecallHooked = true
